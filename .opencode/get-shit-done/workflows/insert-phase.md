...
```bash
INIT=$(node "C:/Users/AnshGupta/Desktop/ARC-HAWK-DD/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${after_phase}")
...
```bash
RESULT=$(node "C:/Users/AnshGupta/Desktop/ARC-HAWK-DD/.opencode/get-shit-done/bin/gsd-tools.cjs" phase insert "${after_phase}" "${description}")
```
