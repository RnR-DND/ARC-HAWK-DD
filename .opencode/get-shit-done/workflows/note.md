...
- **Global scope**: `C:/Users/AnshGupta/Desktop/ARC-HAWK-DD/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/AnshGupta/Desktop/ARC-HAWK-DD/.opencode/notes/`)
...
2. Glob `C:/Users/AnshGupta/Desktop/ARC-HAWK-DD/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/AnshGupta/Desktop/ARC-HAWK-DD/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/AnshGupta/Desktop/ARC-HAWK-DD/.opencode/notes/` — works in any directory
